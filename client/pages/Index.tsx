        ...
        <div className="container mx-auto px-20 max-lg:px-5 flex">
          ...
          <div className="w-3/4 max-lg:hidden relative">
            ...
            <div className="absolute top-0 left-0 w-full h-15 bg-gradient-to-r from-dance-yellow/80 to-dance-yellow/30 rounded-[30px] flex items-center justify-center shadow-lg max-w-xs mx-auto mt-0">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-lg:w-8 max-lg:h-8">
                <path d="M20 5C15 5 12 8 12 12C12 16 15 19 20 19C25 19 28 16 28 12C28 8 25 5 20 5Z" fill="#773FA8"/>
                <path d="M15 20L10 35L14 35L18 25L22 35L26 35L21 20H15Z" fill="#773FA8"/>
                <path d="M25 22L30 37L34 37L29 22H25Z" fill="rgba(119, 63, 168, 0.7)"/>
        ...
        <div className="relative bg-black/30 py-40 px-20 max-lg:px-5 max-lg:py-20">
          <div className="max-w-lg text-white">
            ...
            <div className="text-base font-metrophobic leading-5 space-y-4">
              ...
              <p>
                Od září spouštíme nové kurzy: jeden pro začátečníky, jeden pro mírně
                pokročilé a jeden pro pokročilé. Každý týden pořádáme taneční party,
                kde si můžeš procvičit kroky v přátelské atmosféře. Občas přidáme
                speciální workshopy s hosty.
              </p>
              <p>
                Přijď a staň se součástí naší komunity!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-10 mb-20">
            ...
            <div className="text-white max-lg:mt-10">
              <h2 className="text-3xl font-rammetto mb-8">
                Naše kurzy
              </h2>
          ...
          <div className="grid md:grid-cols-4 gap-12 max-lg:gap-8 text-white text-center">
            <div className="flex flex-col items-center max-lg:mt-10">
              ...
              <p className="text-base font-metrophobic leading-5">
                Na kurzech se spřídáme. Naučíš se tak tancovat s kýmkoli a
                ještě si najdeš kamarády.
              </p>
            </div>
      ...
      <section className="bg-dance-purple py-20 px-14 max-lg:px-5">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-white text-base font-metrophobic leading-5 mb-18 ml-20 max-lg:ml-0 max-w-4xl space-y-4">
            ...
            <p>
              Milujeme West Coast Swing pro jeho hravost a nekonečnou kreativitu.
              Naší vizí je tuto radost sdílet a posouvat dál. Chceme aktivně
              rozšiřovat pražskou komunitu tanečníků. Učit tenhle tanec nás nesmírně
              baví a komunita tanečníků, která se kolem nás rozrůstá je pro nás jako
              dárek, ze kterého máme radost každou lekci.
            </p>
            <p>
              Jsme přátelští, jsme fér a jsme skromní.
            </p>
            <p>
              Přijďte si s námi zatancovat :)
            </p>
          </div>

          {/* Photo Gallery */}
          <div className="flex gap-2 mb-7 justify-center flex-wrap">
            <img src="https://api.builder.io/api/v1/image/assets/9bddeee38234497b88269b80e5be6392/31071cef7bfc0d061e285ef890dbd0e393e45698?placeholderIfAbsent=true" alt="Dance photo 1" className="w-46 object-contain" />
            <img src="https://api.builder.io/api/v1/image/assets/9bddeee38234497b88269b80e5be6392/d03f5a89875425bed4ea6b18e5a6d45a6980b005?placeholderIfAbsent=true" alt="Dance photo 2" className="w-41 object-contain" />
            <img src="https://api.builder.io/api/v1/image/assets/9bddeee38234497b88269b80e5be6392/0567075dfdcb362e586a7574eacb74fee882960a?placeholderIfAbsent=true" alt="Dance photo 3" className="w-43 object-contain" />
            <img src="https://api.builder.io/api/v1/image/assets/9bddeee38234497b88269b80e5be6392/3fa250e960d9087b28cd7fac3c1be9da9cd07fc1?placeholderIfAbsent=true" alt="Dance photo 4" className="w-49 object-contain" />
            <img src="https://api.builder.io/api/v1/image/assets/9bddeee38234497b88269b80e5be6392/eea8c38f9d954003453cfce77c73854e10a57ec3?placeholderIfAbsent=true" alt="Dance photo 5" className="w-56 object-contain" />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="text-white pl-0 pt-40 max-lg:pt-10">
              <h3 className="text-3xl font-rammetto mb-12">
                Kdo u nás učí
              </h3>
        ...
        <div className="container mx-auto">
          ...
          <div className="flex gap-5 items-start justify-between flex-wrap max-lg:gap-10">
            ...
            <div className="text-black text-base font-metrophobic leading-5 max-w-xs">
              ...
              <p className="font-medium text-xl mt-2" style={{fontFamily: 'Reenie Beanie'}}>Josef, IT</p>
            </div>
            <div className="text-black text-base font-metrophobic leading-5 max-w-xs">
              <p>
                Nejdřív mi to přišlo jednoduché, ale s každou hodinou se to trochu
                komplikuje. Moc mě to baví a taky se mi líbí, že jsem mohla začít
                bez partnera a na lekcích se střídáme
              </p>
              <p className="font-medium text-2xl mt-2" style={{fontFamily: 'Reenie Beanie'}}>Vilemína, Pekařka</p>
            </div>
            <div className="text-black text-base font-metrophobic leading-5 max-w-xs">
              <p>Maličké studio s velmi přátelskou atmosférou.</p>
              <p className="font-medium text-xl mt-2" style={{fontFamily: 'Reenie Beanie'}}>Josef, IT</p>
            ...
            <div className="text-black text-base font-metrophobic leading-5 max-w-xs">
              <p>
                Nejdřív mi to přišlo jednoduché, but s každou hodinou se to trochu
                komplikuje. Moc mě to baví a taky se mi líbí, že jsem mohla začít
                bez partnera a na lekcích se střídáme
              </p>
              <p className="font-medium text-2xl mt-2" style={{fontFamily: 'Reenie Beanie'}}>Vilemína, Pekařka</p>
